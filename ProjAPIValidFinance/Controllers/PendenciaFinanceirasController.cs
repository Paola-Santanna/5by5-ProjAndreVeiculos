...
namespace ProjAPIValidFinance.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PendenciaFinanceirasController : ControllerBase
    {
        private readonly ProjAPIValidFinanceContext _context;

        public PendenciaFinanceirasController(ProjAPIValidFinanceContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<PendenciaFinanceira>> PostPendenciaFinanceira(PendenciaFinanceira pendenciaFinanceira)
        {
          if (_context.PendenciaFinanceira == null)
          {
              return Problem("Entity set 'ProjAPIValidFinanceContext.PendenciaFinanceira'  is null.");
          }
