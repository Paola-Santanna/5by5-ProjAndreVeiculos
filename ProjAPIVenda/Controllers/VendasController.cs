...
namespace ProjAPIVenda.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class VendasController : ControllerBase
    {
        private readonly ProjAPIVendaContext _context;

        public VendasController(ProjAPIVendaContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Venda>> PostVenda(Venda venda)
        {
          if (_context.Venda == null)
          {
              return Problem("Entity set 'ProjAPIVendaContext.Venda'  is null.");
          }
