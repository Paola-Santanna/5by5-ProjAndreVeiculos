...
namespace ProjAPISeguro.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class SeguroesController : ControllerBase
    {
        private readonly ProjAPISeguroContext _context;

        public SeguroesController(ProjAPISeguroContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Seguro>> PostSeguro(Seguro seguro)
        {
          if (_context.Seguro == null)
          {
              return Problem("Entity set 'ProjAPISeguroContext.Seguro'  is null.");
          }
