...
namespace ProjAPICondutor.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CondutorsController : ControllerBase
    {
        private readonly ProjAPICondutorContext _context;

        public CondutorsController(ProjAPICondutorContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Condutor>> PostCondutor(Condutor condutor)
        {
          if (_context.Condutor == null)
          {
              return Problem("Entity set 'ProjAPICondutorContext.Condutor'  is null.");
          }
