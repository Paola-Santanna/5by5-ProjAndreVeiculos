...
namespace ProjAPIDependente.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class DependentesController : ControllerBase
    {
        private readonly ProjAPIDependenteContext _context;

        public DependentesController(ProjAPIDependenteContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Dependente>> PostDependente(Dependente dependente)
        {
          if (_context.Dependente == null)
          {
              return Problem("Entity set 'ProjAPIDependenteContext.Dependente'  is null.");
          }
