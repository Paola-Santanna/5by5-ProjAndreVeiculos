...
namespace ProjApiTermoDeUso.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AceiteTermoUsoesController : ControllerBase
    {
        private readonly ProjApiTermoDeUsoContext _context;

        public AceiteTermoUsoesController(ProjApiTermoDeUsoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AceiteTermoUso>> PostAceiteTermoUso(AceiteTermoUso aceiteTermoUso)
        {
          if (_context.AceiteTermoUso == null)
          {
              return Problem("Entity set 'ProjApiTermoDeUsoContext.AceiteTermoUso'  is null.");
          }
