...
namespace ProjAPIFinanciamento.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class FinanciamentoesController : ControllerBase
    {
        private readonly ProjAPIFinanciamentoContext _context;

        public FinanciamentoesController(ProjAPIFinanciamentoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Financiamento>> PostFinanciamento(Financiamento financiamento)
        {
          if (_context.Financiamento == null)
          {
              return Problem("Entity set 'ProjAPIFinanciamentoContext.Financiamento'  is null.");
          }
