...
namespace ProjAPIEndereco.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EnderecoesController : ControllerBase
    {
        private readonly ProjAPIEnderecoContext _context;

        public EnderecoesController(ProjAPIEnderecoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Endereco>> PostEndereco(Endereco endereco)
        {
          if (_context.Endereco == null)
          {
              return Problem("Entity set 'ProjAPIEnderecoContext.Endereco'  is null.");
          }
