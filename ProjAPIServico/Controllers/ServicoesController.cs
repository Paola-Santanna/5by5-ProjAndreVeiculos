...
namespace ProjAPIServico.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ServicoesController : ControllerBase
    {
        private readonly ProjAPIServicoContext _context;

        public ServicoesController(ProjAPIServicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Servico>> PostServico(Servico servico)
        {
          if (_context.Servico == null)
          {
              return Problem("Entity set 'ProjAPIServicoContext.Servico'  is null.");
          }
