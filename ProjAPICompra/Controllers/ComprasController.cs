...
namespace ProjAPICompra.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ComprasController : ControllerBase
    {
        private readonly ProjAPICompraContext _context;

        public ComprasController(ProjAPICompraContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Compra>> PostCompra(Compra compra)
        {
          if (_context.Compra == null)
          {
              return Problem("Entity set 'ProjAPICompraContext.Compra'  is null.");
          }
